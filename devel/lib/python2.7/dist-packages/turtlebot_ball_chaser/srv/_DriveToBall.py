...
"""autogenerated by genpy from turtlebot_ball_chaser/DriveToBallRequest.msg. Do not edit."""
import codecs
import sys
...
class DriveToBallRequest(genpy.Message):
  _md5sum = "6aa08055c0c4aea51799f3f7164796a8"
  _type = "turtlebot_ball_chaser/DriveToBallRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveToBallRequest, self).__init__(*args, **kwds)
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from turtlebot_ball_chaser/DriveToBallResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DriveToBallResponse(genpy.Message):
  _md5sum = "2897a4bc4d7ca330e430870cfdee7314"
  _type = "turtlebot_ball_chaser/DriveToBallResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveToBallResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class DriveToBall(object):
  _type          = 'turtlebot_ball_chaser/DriveToBall'
  _md5sum = 'c8652349d2a34a90a09475339e2a93d9'
  _request_class  = DriveToBallRequest
  _response_class = DriveToBallResponse
